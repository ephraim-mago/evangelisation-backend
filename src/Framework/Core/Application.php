...
class Application extends Container implements ApplicationContract
{
    ...
    public function registerCoreContainerAliases()
    {
        foreach (
            [
                'app' => [self::class, \Framework\Contracts\Core\Application::class, \Framework\Contracts\Container\Container::class, \Psr\Container\ContainerInterface::class],
                'config' => [\Framework\Config\Repository::class],
                'db.connection' => [\Framework\Database\Connection::class],
                'files' => [\Framework\Filesystem\Filesystem::class],
                'hash' => [\Framework\Hashing\HashManager::class],
                'hash.driver' => [\Framework\Contracts\Hashing\Hasher::class],
                'request' => [\Psr\Http\Message\ServerRequestInterface::class, \GuzzleHttp\Psr7\ServerRequest::class, \GuzzleHttp\Psr7\Request::class],
